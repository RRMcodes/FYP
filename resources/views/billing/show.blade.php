...
@section('content')
                                                ...
                                                <table class="table" id="itemTable">
                                                    ...
                                                    @foreach($itemLogs as $key=>$itemLog)
                                                        <tr>
                                                            ...
                                                            <td><input type="text" value="{{$items->where('id', $itemLog->item_id)->first()->name}}" data-id="{{$itemLog->item_id}}" class="itemName" name="item_name" disabled></td>
                                                            <td><input type="number" value="{{$itemLog->quantity}}" class="quantity" name="quantity[]"   disabled></td>
                                                            <td><input type="number" value="{{$items->where('id', $itemLog->item_id)->first()->price}}" class="price" name="price[]" disabled></td>
                                                            <td><input type="number" value="" class="sub_total" name="sub_total[]" disabled></td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
                                                </table>
    ...
    <script>
            ...
            tableRows.forEach((row) => {
                ...
                // Get item ID and input fields for quantity, price, and subtotal
                var price = row.querySelector(".price").value;
                var quantity = row.querySelector(".quantity").value;


                var sub_total = price * quantity;
                row.querySelector(".sub_total").value = sub_total;
